const Card = ({ src, title, price }) => {
  return (
    <div className="col-span-12  sm:col-span-6 md:col-span-6 lg:col-span-4 flex flex-col items-center">
      <img alt={title} src={src} className="h-[400px] xl:h-[500px]" />
      <h2 className="font-PassionOne text-4xl text-center w-10/12 my-2">
        {title}
      </h2>
